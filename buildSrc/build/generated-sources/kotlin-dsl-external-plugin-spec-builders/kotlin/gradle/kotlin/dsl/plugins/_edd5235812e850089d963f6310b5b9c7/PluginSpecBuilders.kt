...
package gradle.kotlin.dsl.plugins._edd5235812e850089d963f6310b5b9c7
...
/**
 * The `de.mannodermaus` plugin group.
 */
@org.gradle.api.Generated
internal
class `DeMannodermausPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `de.mannodermaus`.
 */
internal
val `DePluginGroup`.`mannodermaus`: `DeMannodermausPluginGroup`
    get() = `DeMannodermausPluginGroup`(plugins)


/**
 * The `de.mannodermaus.android-junit5` plugin implemented by [de.mannodermaus.gradle.plugins.junit5.AndroidJUnitPlatformPlugin].
 */
internal
val `DeMannodermausPluginGroup`.`android-junit5`: PluginDependencySpec
    get() = plugins.id("de.mannodermaus.android-junit5")
...
/**
 * The `org.jlleitschuh` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgJlleitschuhPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.jlleitschuh`.
 */
internal
val `OrgPluginGroup`.`jlleitschuh`: `OrgJlleitschuhPluginGroup`
    get() = `OrgJlleitschuhPluginGroup`(plugins)


/**
 * The `org.jlleitschuh.gradle` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgJlleitschuhGradlePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.jlleitschuh.gradle`.
 */
internal
val `OrgJlleitschuhPluginGroup`.`gradle`: `OrgJlleitschuhGradlePluginGroup`
    get() = `OrgJlleitschuhGradlePluginGroup`(plugins)


/**
 * The `org.jlleitschuh.gradle.ktlint` plugin implemented by [org.jlleitschuh.gradle.ktlint.KtlintPlugin].
 */
internal
val `OrgJlleitschuhGradlePluginGroup`.`ktlint`: PluginDependencySpec
    get() = plugins.id("org.jlleitschuh.gradle.ktlint")


/**
 * The `org.jlleitschuh.gradle.ktlint-idea` plugin implemented by [org.jlleitschuh.gradle.ktlint.KtlintIdeaPlugin].
 */
internal
val `OrgJlleitschuhGradlePluginGroup`.`ktlint-idea`: PluginDependencySpec
    get() = plugins.id("org.jlleitschuh.gradle.ktlint-idea")
